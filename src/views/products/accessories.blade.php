    ...
    <div class="col-md-12">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                ...
                <a href="{{URL::action('Palmabit\Catalog\Controllers\ProductsController@postDetachProduct', ['_token' => csrf_token(), 'first_product_id' => $product->id, 'second_product_id' => $_product->id, 'slug_lang' => $slug_lang] ) }}" class="pull-right delete-acc tab-remember"><i class="glyphicon glyphicon-trash"></i> Rimuovi</a>
            </li>
            @endforeach
            @else
