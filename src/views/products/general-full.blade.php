...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        {{FormField::code(["label" => L::t("Codice*: ")])}}
    ...
    <div class="col-md-6">
        {{FormField::video_link(["type" => "text", "label" => L::t("URL video (youtube):") ])}}
        <span class="text-danger">{{$errors->first('video_link')}}</span>
        <div class="form-group">
            <label for=​"price1" class=​"control-label">{{L::t('​Prezzo1:​')}}</label>​
        ...
        <div class="form-group">
            <label for=​"price2" class=​"control-label">{{L::t('​Prezzo2:')}}</label>​
            <div class="input-group">
              <span class="input-group-addon">€</span>
                {{--  please keep in mind this null will be replaced with the populated value from the form class --}}
        ...
        <div class="form-group">
            <label for=​"price3" class=​"control-label">​{{L::t('Prezzo3')}}:</label>​
            <div class="input-group">
              <span class="input-group-addon">€</span>
                {{--  please keep in mind this null will be replaced with the populated value from the form class --}}
        ...
        <div class="form-group">
            <label for=​"price4" class=​"control-label">{{L::t('​Prezzo4:')}}</label>​
            <div class="input-group">
                <span class="input-group-addon">€</span>
                {{--  please keep in mind this null will be replaced with the populated value from the form class --}}
        ...
        <div class="form-group">
            {{Form::label("",L::t("Abilita gestione quantità: "))}}
        ...
        {{FormField::quantity_pricing_quantity(["label" => L::t("Quantità professionista")])}}
        <span class="text-danger">{{$errors->first('quantity_pricing_quantity')}}</span>
        {{FormField::quantity_pricing_quantity_non_professional(["label" => L::t("Quantità non professionista")])}}
        <span class="text-danger">{{$errors->first('quantity_pricing_quantity_non_professional')}}</span>
        <div class="form-group">
            {{Form::label("with_vat", L::t("Iva inclusa: ") )}}
            {{Form::select('with_vat', ["1" => "Sì", "0" => "No"], null, ["class"=> "form-control"] )}}
        </div>
        <div class="form-group">
            {{Form::label("stock",L::t("Giacenza (disponibilità in magazzino)") )}}
            {{Form::select('stock', ["1" => "Sì", "0" => "No"], null, ["class"=> "form-control"] )}}
        </div>
        <div class="form-group">
            {{Form::label("professional", L::t("Prodotto professionale") )}}
            {{Form::select('professional', ["0" => "No", "1" => "Sì"], null, ["class"=> "form-control"] )}}
        </div>
        <div class="form-group">
            {{Form::label("public", L::t("Prodotto pubblico") )}}
            {{Form::select('public', ["1" => "Sì", "0" => "No"], null, ["class"=> "form-control"] )}}
        </div>
        <div class="form-group">
            {{Form::label("featured",L::t("Prodotto in evidenza") )}}
            {{Form::select('featured', ["0" => "No", "1" => "Sì"], null, ["class"=> "form-control"] )}}
        </div>
        <div class="form-group">
            {{Form::label("offer",L::t("Prodotto in offerta") )}}
