<ul class="nav nav-tabs" id="tab-prodotto">
    ...
    <li id="link-tab-tags" class="tab-link"><a href="#tab-tags" {{$presenter->get_toggle()}} >Tags</a></li>
    <li id="link-tab-tags" class="tab-link"><a href="#tab-accessori" {{$presenter->get_toggle()}} >Accessori</a></li>
