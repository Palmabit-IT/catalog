...
<ul class="list-group">
    ...
    <li class="list-group-item">
        ...
        <a href="{{URL::action('Palmabit\Catalog\Controllers\ProductsController@postDetachCategory', ['_token' => csrf_token(), 'product_id' => $product->id, 'slug_lang' => $slug_lang, 'category_id' => $category->id])}}" class="pull-right tab-remember cancella">Rimuovi</a>
    </li>
    @endforeach
    @else
...
<div class="form-group">
    {{Form::label("categoria","Associa categoria")}}
