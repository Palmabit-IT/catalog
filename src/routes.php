...
Route::group( ['before' => ['logged'] ], function()
{
    ...
    //@todo add csrf ui
    Route::any('/admin/products/edit',['as'=>'products.delete','uses' =>'Prodotti\Controllers\ProductsController@delete']);
    //////////////// PRODUCT CATEGORIES //////////////////
    ...
    ////////////////////// PRODUCT IMAGE ////////////////////////
    Route::post('/admin/products/images/edit',['as'=>'products.images', "before" => "csrf", 'uses' =>'Palmabit\Catalog\Controllers\ProductsController@postImmage']);
    //@todo add csrf ui
    Route::any('/admin/products/images/deletr',['as'=>'products.images.delete','uses' => 'Palmabit\Catalog\Controllers\ProductsController@deleteImage']);
    //@todo add csrf ui
