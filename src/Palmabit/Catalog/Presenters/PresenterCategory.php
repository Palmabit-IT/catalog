...
class PresenterCategory extends AbstractPresenter implements ProductCategoryPresenterInterface{
 use ViewHelper;
    ...
    {
        $data = $this->resource->image ? "data:image/png;base64,{$this->resource->image}" : "data:image/png;base64,".base64_encode(ProductImage::getImageFromUrl($this->default_img_path) );
